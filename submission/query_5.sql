...
SELECT 
    ...
    total_team_wins
FROM aggr
WHERE team <> '(overall)' -- Make sure its a team and not grouping set aggregate
ORDER BY total_team_wins DESC -- Sort of highest points at the top
LIMIT 1 -- Get the top 1 team only
