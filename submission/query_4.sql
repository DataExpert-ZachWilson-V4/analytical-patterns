...
-- Select the relevant columns to identify the player and season with the most points
select
...
where grouping_type = 'player_season'             -- Filter to only include 'player_season' groupings
